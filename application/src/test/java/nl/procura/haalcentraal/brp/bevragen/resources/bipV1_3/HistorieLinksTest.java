 ...
 *   In de _links van een ingeschreven persoon kunnen links worden opgenomen naar de historische resources van
 *   dezelfde persoon.
 *
 *   Wanneer de API "Historie ingeschreven personen" beschikbaar is, MOET de resource ingeschrevenpersonen de volgende
 *   links bevatten naar historische resources:
 *   - partnerhistorie
 *   - verblijfsplaatsenhistorie
 *   - verblijfstitelshistorie
 *   - nationaliteithistorie
 *
 *   Wanneer de API "Historie ingeschreven personen" NIET beschikbaar is, mag de resource ingeschrevenpersonen GEEN
 *   links bevatten naar historische resources.
 */
public class HistorieLinksTest extends IngeschrevenPersonenResourceTest {
  ...
  @Test
  @SneakyThrows
  public void checkHistoryWithoutParameters() {
    //        Long bsnL = 0L;
  ...
  @Test
  @SneakyThrows
  public void checkHistoryWithoutParametersWithoutAccess() {
    //        Long bsnL = 0L;
    //        IngeschrevenPersoonHalCollectie persons = getIngeschrevenPersonen(bsnL);
  ...
  @Test
  @SneakyThrows
  public void checkHistoryWithParameters() {
    //        Long bsnL = 0L;
    //        IngeschrevenPersoonHalCollectie persons = getIngeschrevenPersonen(bsnL);
  ...
  @Test
  @SneakyThrows
  public void checkHistoryWithParametersWithoutAccess() {
    //        Long bsnL = 0L;
    //        IngeschrevenPersoonHalCollectie persons = getIngeschrevenPersonen(bsnL);
