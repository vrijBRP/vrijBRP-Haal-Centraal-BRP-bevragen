 ...
 * worden gebruikt.
 * Zoeken binnen GBA tabellen is ook case-insensitive. Bijvoorbeeld zoeken op voorvoegselGeslachtsnaam "van" vindt zowel
 * "van" als "Van". Ook zoeken op voorvoegselGeslachtsnaam "VAN" vindt zowel "van" als "Van"
 * Wanneer er op de parameter een patroon (pattern) is gedefinieeerd, moet de invoer hieraan voldoen. Bijvoorbeeld voor
 * zoeken op verblijfplaats__postcode moet een geldige postcode worden opgegeven (dus met hoofdletters).
 */
public class CaseInsensitivityTest extends IngeschrevenPersonenResourceTest {
  ...
  @Test
  @SneakyThrows
  public void checkFieldForCaseInsensitivity() {
    //FIXME: requires different methods to find a person based on a textfield instead of bsn
  }
  ...
  @Test
  @SneakyThrows
  public void checkEnumerationForCaseSensitivity() {
    //FIXME: requires different methods to find a person based on a textfield instead of bsn
  }
}
