...
public class RestConfig {
  ...
  @Bean
  public GroupedOpenApi openApiGroupBip() {
    return GroupedOpenApi.builder()
        .setGroup("bevraging-ingeschreven-personen")
        .packagesToScan(IngeschrevenPersonenResourceV1.class.getPackageName())
        .addOpenApiCustomiser(openApi -> openApi
