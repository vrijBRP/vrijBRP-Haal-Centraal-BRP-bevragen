...
import nl.procura.haalcentraal.brp.api.v1_3.client.handler.ApiClient;
...
@Value
public class HcBrpBevragenApiClientV1_3 {
  ...
  @Builder
  public HcBrpBevragenApiClientV1_3(ApiClient apiClient, OAuth oAuth, ApiClientConfiguration config) {
    this.config = config;
